...
public class WaveView extends View {
    ...
    private int lineWidth = 30;//竖线的宽度
    private int lineSpace = 50;//竖线之间的间隔宽度
    ...
    private int fullValue = 10;//相对最大值
    ...
    private void init(AttributeSet attrs){
        ...
        lineWidth = typedArray.getDimensionPixelSize(R.styleable.WaveView_wvLineWidth,30);
        lineSpace = typedArray.getDimensionPixelSize(R.styleable.WaveView_wvLineSpace,50);
