 ...
 */
public class VideoPlayer extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, SurfaceHolder.Callback, View.OnTouchListener, JCMediaManager.JCMediaPlayerListener {
    ...
    private static BuriedPoint JC_BURIED_POINT;
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.start || i == R.id.thumb) {
            ...
            if (ifFullScreen) {
                ...
                FullScreenActivity.toActivityFromNormal(getContext(), CURRENT_STATE, url, title);
...
//            ((TextVideoView) getContext()).finish();
        }
    }
...
//            JCMediaManager.intance().mediaPlayer.stop();
    ...
    public static void releaseStop() {
    ...
    public static void toFullscreenActivity(Context context, String url, String title) {
        FullScreenActivity.toActivity(context, url, title);
    }
