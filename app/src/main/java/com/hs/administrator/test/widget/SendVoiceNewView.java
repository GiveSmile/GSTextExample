...
//                        setIsTouchable(false);
    ...
    private void initNormAnim(){
        ...
        ovalrvalueAnimator.setRepeatMode(ValueAnimator.RESTART);
        ...
        ovaltvalueAnimator.setRepeatMode(ValueAnimator.RESTART);
    ...
    private void initItemAnim(){
        ...
        itemminvalueAnimator.setRepeatMode(ValueAnimator.RESTART);
        ...
        itemmaxvalueAnimator.setRepeatMode(ValueAnimator.RESTART);
